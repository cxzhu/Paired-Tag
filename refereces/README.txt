...
cell_id_full.fa ## used to generate a 96 barcodes bowtie index for demultiplexing cellular barcodes
cell_id_full_407.fa ## used to generate a 384 barcodes bowtie index for demultiplexing cellular barcodes. Barcodes length is also different from cell_id_full.fa 
