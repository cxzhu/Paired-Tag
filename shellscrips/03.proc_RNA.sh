...
trim_galore -a AAAAAAAAAAAAAAAACCTGCAGGNNNNACGAATGCTCTGGCCTNNNNNNNNNN ${s}_BC_cov_trimmed.fq.gz ### trim oligo-dT primer
trim_galore -a CCTGCAGGNNNNACGAATGCTCTGGCCTNNNNNNNNNN ${s}_BC_cov_trimmed.fq.gz ## trim N6 primer
