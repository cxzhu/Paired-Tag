...
trim_galore -a AAAAAAAAAAAAAAAACCTGCAGGNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN ${s}_BC_cov_trimmed.fq.gz ### trim oligo-dT primer
trim_galore -a CCTGCAGGNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN ${s}_BC_cov_trimmed.fq.gz ## trim N6 primer
